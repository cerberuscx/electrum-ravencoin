...
from electrum.ravencoin import COIN, TOTAL_COIN_SUPPLY_LIMIT_IN_BTC
...
class RVNAmountEdit(AmountEdit):
    ...
    def __init__(self, decimal_point, asset_base_unit=None, is_int=False, parent=None, *, max_amount=_NOT_GIVEN):
        if max_amount is _NOT_GIVEN:
            max_amount = TOTAL_COIN_SUPPLY_LIMIT_IN_BTC * COIN
        AmountEdit.__init__(self, asset_base_unit or self._base_unit, is_int, parent, max_amount=max_amount)
